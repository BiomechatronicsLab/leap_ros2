    ...
    def __init__(self):
        ...
        if self.hand_side == 'left':
            for i in range(len(self.positions_to_command)):
                self.positions_to_command[i][9] = -self.positions_to_command[i][9]  # Index 9
                self.positions_to_command[i][5] = -self.positions_to_command[i][5]  # Index 5
                self.positions_to_command[i][1] = -self.positions_to_command[i][1]  # Index 1
