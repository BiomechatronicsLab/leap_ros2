...
class TestDynamixelConnection:
    ...
    def setup_method(self):
        ...
        self.port_open = self.port_handler.openPort()
    ...
    def test_connection_success(self):
        ...
        assert self.port_open, "Failed to open port"
    ...
    def test_connection_failure(self):
        # Simulate a failure scenario (e.g., wrong device name or disconnected motor)
        invalid_device_name = "/dev/serial/by-id/usb-invalid-port"
        invalid_port_handler = dxl.PortHandler(invalid_device_name)
        try:
            invalid_port_open = invalid_port_handler.openPort()
        except:
            invalid_port_open = None
        # Test if the invalid port fails to open
        assert not invalid_port_open, "Port should not open with an invalid device name"
