...
def test_motor_connection(dynamixel_manager):
    packet_handler = dynamixel_manager._packet_handler
    port_handler = dynamixel_manager._port_handler
    ...
    for motor_id in dynamixel_manager.motor_ids:
        ...
        assert model_number == dynamixel_manager._model_number, "Ping failed: Invalid model number" # Specific ID for the dynamixel
